...
#pragma warning restore IDE0032
    ...
    public static string LogDirectoryPath { get; } = Path.Combine(Path.GetTempPath(), "SyntaxInspectors.Analyzers");

    public static string FilePath
    {
        get
        {
            const string logFileNamePattern = $"SyntaxInspectors.Analyzers.PDI-{ProcessIdPlaceholder}.TID-{ThreadIdPlaceholder}.log";
    ...
    public static string DurationMeasurementFilePath
    {
        get
        {
            const string durationMeasurementLogFileNamePattern = $"SyntaxInspectors.Analyzers.DurationMeasurement.PDI-{ProcessIdPlaceholder}.TID-{ThreadIdPlaceholder}.log";
