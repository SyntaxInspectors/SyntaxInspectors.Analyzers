...
| [SIEF0001](https://github.com/SyntaxInspectors/SyntaxInspectors.Analyzers/blob/main/docs/Rules/SIEF0001.md) | Style                   | Entity Framework |    ⚠️    |      ❌       | AsNoTracking() should be first in the chain                                      |
| [SIEF0002](https://github.com/SyntaxInspectors/SyntaxInspectors.Analyzers/blob/main/docs/Rules/SIEF0002.md) | Performance             | Entity Framework |    ⚠️    |      ❌       | Avoid using synchronous EF Core methods                                          |
